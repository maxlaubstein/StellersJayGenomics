...
pca <- read_table("Z_PCA.eigenvec", col_names = FALSE)
eigenval <- scan("Z_PCA.eigenval")
...
ggsave(plot = plot + theme(legend.position = "none"), filename = "Z_PCA_all.pdf", device = "pdf", height = 3.5, width = 3.5, units = "in")
...
# Save to file
ggsave(plot = legend_plot, filename = "Z_PCA_legend.pdf", width = 7, height = 1.2, units = "in")
...
# Save as HTML
saveWidget(as_widget(plotly_plot), file = "Z_PCA_all.html")
