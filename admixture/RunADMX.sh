...
plink --vcf ../../VCFdata/autosomal_annotated_pruned.recode.vcf --make-bed --allow-extra-chr 
plink --bfile VCFdata/autosomal_annotated_pruned --recode --out autosomal_annotated_pruned --allow-extra-chr

for K in 2 3 4 5 6 7 8 9 ; do admixture --cv autosomal_annotated_pruned.ped $K | tee ADMXlog${K}.out; done
